...
const Team = () => {
  ...
  return (
    <div className="mx-auto flex justify-center mt-2 px-4 py-10">
      <div className="bg-blue-200 w-full lg:w-[75%] py-10 rounded-2xl overflow-x-auto lg:mt-[100px] mt-[60px]">
        <div className="px-7">
