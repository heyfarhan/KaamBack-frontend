      ...
      <nav className="bg-[#041893] text-white p-2">
        <div className="container mx-auto px-8 flex justify-between items-center">
          ...
          <div className="flex flex-col items-start">
            ...
            {/* Tagline */}
            <p className="text-sm font-light">"Where Experience meets Opportunity"</p>
          </div>
          ...
          <div className="bg-white text-[#041893] py-2 px-6 rounded-full hidden md:block">
            <span className="font-bold">Hi,</span> {userName} {/* Dynamically displaying user name */}
          </div>
        </div>
      </nav>
    </div>
