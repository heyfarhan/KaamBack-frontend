    ...
    <div className="min-h-screen flex flex-col bg-[#f0f0ff] text-[#041893]">
      ...
      <div className="flex-grow flex items-center justify-center">
        ...
        >
          ...
          {/* Full legal name */}
          <div>
            <label className="block font-semibold mb-1 text-gray-600">Full Legal Name</label>
            <input
              type="text"
              name="fullName"
          ...
          {/* Contact number */}
          <div>
            <label className="block font-semibold mb-1 text-gray-600">Contact Number</label>
            <input
              type="tel"
              name="contactNumber"
          ...
          {/* Current City */}
          <div>
            <label className="block font-semibold mb-1 text-gray-600">Current City</label>
            <input
              type="text"
              name="city"
              value={formData.city}
          ...
          {/* Languages */}
          <div>
            <label className="block font-semibold mb-1 text-gray-600">Languages You Know</label>
            <div className="grid grid-cols-2 gap-4 mt-2">
              {['English', 'Tamil', 'Telugu', 'Hindi', 'Marathi', 'Japanese'].map((lang) => (
          ...
          {/* Work mode */}
          <div>
            <label className="block font-semibold mb-1 text-gray-600">Work Mode</label>
            <div className="flex space-x-6">
          ...
          {/* Resume */}
          <div>
            <label className="block font-semibold mb-1 text-gray-600">Upload Resume</label>
            <input
              type="file"
