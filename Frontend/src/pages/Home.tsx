      ...
      <div className='flex flex-col items-center bg-white'>
        ...
        <div className='bg-[#00569F] flex flex-col gap-y-16 mt-10'>
          <div className='flex flex-col lg:flex-row px-6 lg:px-24 items-center mt-10'>
            ...
            >
              <p className='text-4xl text-white font-extrabold font-ptSans tracking-wide leading-10'>Adapt. Grow. Scale. <br />Your Workforce Solution.</p>
              <p className='mt-3 text-xl text-white font-ptSans font-thin tracking-wider'>Fuel your growth journey effortlessly! Scale your workforce dynamically to meet project demands and seize new business opportunities.</p>
            </motion.div>
            <motion.div
              ref={ref1}
              initial="hidden"
          ...
          <div className='flex flex-col lg:flex-row px-6 lg:px-24 items-center'>
            ...
            >
              <p className='text-4xl text-white font-extrabold font-ptSans tracking-wide leading-10'>Budget Mastery:<br />Efficient. Smart. Contract-Based Excellence.</p>
              <p className='mt-3 text-lg text-white font-ptSans font-thin tracking-wider'>Master the art of financial efficiency! Optimize costs by engaging skilled professionals on a contract basis, sparing your budget from the weight of full-time overheads.</p>
            </motion.div>
          </div>
          <div className='flex flex-col lg:flex-row px-6 lg:px-24 items-center mb-10'>
            <motion.div
              ...
              className='w-full lg:w-1/2 mb-6 lg:mb-0'
            >
              <p className='text-4xl text-white font-extrabold font-ptSans tracking-wide leading-10'>Swift Onboarding. Precise Execution.<br />Project Ignition.</p>
              <p className='mt-3 text-lg text-white font-ptSans font-thin tracking-wider'>Ignite projects with speed and precision! Quickly onboard professionals to ensure timely kick-offs and efficient execution, propelling your ventures to success.</p>
              <button className='px-12 py-4 bg-white text-[#4351E8] mt-4 rounded-md font-semibold'>Discover Now</button>
            </motion.div>
            <motion.div
              ref={ref3}
              initial="hidden"
