  ...
  return (
    <div className="flex h-screen bg-indigo-50">
      ...
      <div className="flex flex-col flex-grow p-8 space-y-6">
        {/* Search Bar */}
        <div className="bg-white p-4 rounded-xl shadow-md flex items-center w-1/3"> {/* Reduced width */}
          <input
            type="text"
            placeholder="Search"
        ...
        {/* New Applications */}
        <div className="bg-white rounded-xl shadow-md p-6 w-1/3"> {/* Reduced width */}
