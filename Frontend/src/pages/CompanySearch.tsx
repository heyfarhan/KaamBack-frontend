...
const CompanySearch: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen bg-blue-50 font-[Arial, Helvetica, sans-serif]">
      {/* Sidebar */}
      <div className="bg-blue-800 w-64 text-white flex flex-col items-center py-6 font-bold">
        <img src={Logo} alt="KaamBack Logo" className="w-32 h-auto mb-10 rounded-full" />
      ...
      <div className="flex flex-col md:flex-row flex-1 p-10 gap-8">
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg w-full md:w-1/3">
          ...
          <div className="mb-6">
            <label className="block text-gray-700 mb-2">Desired minimum monthly Salary (₹)</label>
            <input type="range" className="w-full" min="0" max="60000" step="1000" />
          ...
          {companyListings.map((company, index) => (
            ...
            >
              <div className="flex items-center space-x-4">
                <img src={company.image} alt={company.name} className="w-16 h-16 rounded-full" />
                <div>
