...
const EditProfile = () => {
  ...
  return (
    <div className="flex min-h-screen bg-blue-50 font-[Arial, Helvetica, sans-serif]"> {/* Light blue background added */}
      {/* Sidebar */}
      <div className="bg-blue-800 w-64 text-white flex flex-col items-center py-5 font-bold">
        {/* Logo */}
        <img src={Logo} alt="KaamBack Logo" className="w-32 h-auto mb-8" />
        ...
        <div className="mt-auto flex flex-col items-center">
          <Link to="/settings" className="mb-8">Settings</Link>
      ...
      <div className="w-full h-full rounded-full bg-gray-300 flex items-center justify-center relative shadow-md">
        <FaUserCircle className="text-gray-600 w-12 h-12" /> {/* Profile photo placeholder */}
      </div>
      <p className="absolute bottom-0 left-1/2 transform -translate-x-1/2 text-xs text-blue-500 hover:underline cursor-pointer">
        ...
        <div className="mx-auto w-3/4"> 
          <form className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-gray-700 font-medium mb-2">Field of Experience</label>
              ...
              <div>
                <label className="block text-gray-700 font-medium mb-2">Years of Experience in Primary Job Interest</label>
                <input
                  type="number"
                  className="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:border-blue-300"
